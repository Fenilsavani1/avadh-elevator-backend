exports.PermissionsData = [
  ...
  { id: 50, permission_name: "View Mechanical Qc" },
  { id: 51, permission_name: "Add Mechanical Qc" },
  { id: 52, permission_name: "Edit Mechanical Qc" },
  { id: 53, permission_name: "Delete Mechanical Qc" },


  { id: 54, permission_name: "View Report" },
  { id: 55, permission_name: "Add Report" },
  { id: 56, permission_name: "Edit Report" },
  { id: 57, permission_name: "Delete Report" },

  { id: 58, permission_name: "View Activity log" },
  { id: 59, permission_name: "Add Activity log" },
  { id: 60, permission_name: "Edit Activity log" },
  { id: 61, permission_name: "Delete Activity log" },


  { id: 62, permission_name: "View Vender list" },
  { id: 63, permission_name: "Add Vender list" },
  { id: 64, permission_name: "Edit Vender list" },
  { id: 65, permission_name: "Delete Vender list" },
...
exports.PermissionRolesData = [
  ...
  { id: 31, role_id: 1, permission_id:  31},
  { id: 32, role_id: 1, permission_id:  32},
  { id: 33, role_id: 1, permission_id:  33},
  { id: 34, role_id: 1, permission_id:  34},
  { id: 35, role_id: 1, permission_id:  35},
  { id: 36, role_id: 1, permission_id:  36},
  { id: 37, role_id: 1, permission_id:  37},
  { id: 38, role_id: 1, permission_id:  38},
  { id: 39, role_id: 1, permission_id:  39},
  ...
  { id: 47, role_id: 1, permission_id:  47},
  { id: 48, role_id: 1, permission_id:  48},
  { id: 49, role_id: 1, permission_id:  49},
  { id: 50, role_id: 1, permission_id:  50},
  { id: 51, role_id: 1, permission_id:  51},
  { id: 52, role_id: 1, permission_id:  52},
  { id: 53, role_id: 1, permission_id:  53},
  { id: 54, role_id: 1, permission_id:  54},
  { id: 55, role_id: 1, permission_id:  55},
  { id: 56, role_id: 1, permission_id:  56},
  { id: 57, role_id: 1, permission_id:  57},
  { id: 58, role_id: 1, permission_id:  58},
  { id: 59, role_id: 1, permission_id:  59},
  { id: 60, role_id: 1, permission_id:  60},
  { id: 61, role_id: 1, permission_id:  61},
  { id: 62, role_id: 1, permission_id:  62},
  { id: 63, role_id: 1, permission_id:  63},
  { id: 64, role_id: 1, permission_id:  64},
  { id: 65, role_id: 1, permission_id:  65},
